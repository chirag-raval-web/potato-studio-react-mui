...
export const EngagementModels = [
  {
    title: "Retainership",
    description:
      "Retainership model is best suited for when your project scope is not clearly defined - in sense of timelines or tasks. You get a dedicated team of resources who help you constantly for the set duration.",
    CoverImg: `${process.env.PUBLIC_URL}/media/services/en1.webp`,
    Logos: [
      { src: `${process.env.PUBLIC_URL}/media/partners/realince.svg` },
      { src: `${process.env.PUBLIC_URL}/media/partners/obvious.svg` },
      { src: `${process.env.PUBLIC_URL}/media/partners/fighter.svg` },
    ],
  },
  {
    title: "In-house Designs",
    description:
      "For projects with well-defined requirements and timelines, the In-house Design model is the perfect fit. We outline the scope of work and deliver within an agreed timeline, with a seasoned team dedicated to bringing your vision to life.",
    CoverImg: `${process.env.PUBLIC_URL}/media/services/en1.webp`,
    Logos: [
      { src: `${process.env.PUBLIC_URL}/media/partners/realince.svg` },
      { src: `${process.env.PUBLIC_URL}/media/partners/obvious.svg` },
...
export const ApproachData = [
  ...
  },
  {
    ...
    title: "Strategy",
    description:
      "The process of aligning accurate research insights with the goals.",
    link: [
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "UX/UI Design focuses on creating user-friendly and visually appealing interfaces for digital products. It ensures that users can navigate and interact with a product effortlessly, enhancing their overall experience.",
        },
        item2: {
          ...
          answer: {
            item1: {
              ...
              description:
                "Creates interfaces that capture attention and keep users engaged.",
            },
            item2: {
            ...
            item3: {
              ...
              description:
                "Ensures a cohesive visual identity across platforms.",
            },
            item4: {
              title: "Business Impact",
              description:
                "Boosts conversions and customer satisfaction through seamless interactions.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            ...
            item2: {
              title: "Redesign",
              description:
                "When revamping an existing product to improve usability.",
            },
            item3: {
              title: "Post-Launch",
              description:
                "To refine and enhance the user experience based on feedback.",
            },
          },
        },
        item2: {
          ...
          answer: {
            ...
            item4: {
              title: "Testing",
              description:
                "Validating designs with real users for continuous improvement.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "Mobile App Design involves creating user interfaces and experiences specifically for mobile applications, ensuring functionality and usability across various devices.",
        },
        item2: {
          ...
          answer: {
            ...
            item2: {
              title: "Accessibility",
              description:
                "Ensures apps are usable for all users, including those with disabilities.",
            },
            item3: {
              title: "Performance",
              description:
                "Optimized designs improve app speed and functionality.",
            },
            item4: {
              title: "User Feedback",
              description:
                "Encourages user interaction and feedback, leading to better improvements.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            item1: {
              ...
              description:
                "At the inception of an app to establish a strong foundation.",
            },
            item2: {
              title: "Feature Updates",
              description:
                "When adding new functionalities to enhance user experience.",
            },
            item3: {
        ...
        item2: {
          ...
          answer: {
            ...
            item2: {
              title: "Prototyping",
              description:
                "Creating initial app models for testing and feedback.",
            },
            item3: {
              title: "Visual Design",
              description:
                "Crafting aesthetically pleasing interfaces that attract users.",
            },
            item4: {
              title: "Usability Testing",
              description:
                "Gathering user feedback to refine and enhance the app.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "Website Design is the process of planning and creating the elements of a website, including layout, content, and user experience.",
        },
        item2: {
          ...
          answer: {
            item1: {
              ...
              description:
                "Captivating design can attract and retain visitors.",
            },
            item2: {
              title: "User Experience",
              description:
                "A well-designed website enhances user satisfaction and usability.",
            },
            item3: {
              title: "SEO Benefits",
              description:
                "Proper design contributes to better search engine rankings.",
            },
            item4: {
              title: "Mobile Responsiveness",
              description:
                "Ensures accessibility on various devices and screen sizes.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            item1: {
              ...
              description:
                "At the creation of a website to ensure quality and effectiveness.",
            },
            item2: {
              title: "Redesign Projects",
              description:
                "When existing websites need a fresh look or improved functionality.",
            },
            item3: {
              title: "Brand Refresh",
              description:
                "When rebranding efforts are underway to align visuals with the new identity.",
            },
          },
        },
        item2: {
          ...
          answer: {
            item1: {
              title: "Wireframing",
              description:
                "Creating blueprints for website structure and navigation.",
            },
            item2: {
              title: "Content Strategy",
              description:
                "Defining how content will be displayed and organized.",
            },
            item3: {
              title: "Visual Design",
              description:
                "Crafting an appealing and effective visual aesthetic.",
            },
            item4: {
              title: "Testing & Launch",
              description:
                "Conducting tests before launching the website to the public.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "Dashboard Design is the process of creating user interfaces that display key performance indicators and data insights clearly and effectively.",
        },
        item2: {
          ...
          answer: {
            item1: {
              ...
              description:
                "Transforms complex data into easily understandable visuals.",
            },
            item2: {
            ...
            item3: {
              ...
              description:
                "Supports better decisions through clear data presentation.",
            },
            item4: {
              title: "Customization",
              description:
                "Allows users to personalize their dashboards for relevant insights.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            item1: {
              ...
              description:
                "When developing tools that require data visualization.",
            },
            item2: {
              title: "Feature Enhancements",
              description:
                "When adding new functionalities to existing dashboards.",
            },
            item3: {
              title: "User Feedback Incorporation",
              description:
                "To adapt designs based on user input and preferences.",
            },
          },
        },
        item2: {
          ...
          answer: {
            ...
            item3: {
              ...
              description:
                "Connecting relevant data sources for real-time insights.",
            },
            item4: {
              title: "Usability Testing",
              description:
                "Gathering user feedback to optimize the dashboard experience.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "UX Research involves studying users and their behaviors to gather insights that inform design decisions.",
        },
        item2: {
          ...
          answer: {
            item1: {
              ...
              description:
                "Focuses on creating solutions tailored to user needs.",
            },
            item2: {
              title: "Identifying Pain Points",
              description:
                "Helps uncover issues users face during interactions.",
            },
            item3: {
            ...
            item4: {
              ...
              description:
                "Enhances the overall user experience, leading to happier users.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            item1: {
              ...
              description:
                "To gather insights before starting the design process.",
            },
            item2: {
            ...
            item3: {
              ...
              description:
                "To assess user satisfaction and areas for improvement.",
            },
          },
        },
        item2: {
          ...
          answer: {
            ...
            item2: {
              title: "Interviews",
              description:
                "Conducting one-on-one discussions to gain in-depth insights.",
            },
            item3: {
              title: "Usability Testing",
              description:
                "Observing users as they interact with products to identify issues.",
            },
            item4: {
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "Branding is the process of creating a unique identity and image for a product or company through design and marketing.",
        },
        item2: {
          ...
          answer: {
            ...
            item4: {
              title: "Consistency",
              description:
                "Ensures uniformity across all marketing materials and platforms.",
            },
          },
        },
      },
        ...
        item1: {
          ...
          answer: {
            ...
            item2: {
              ...
              description:
                "When refreshing an existing brand to attract new customers.",
            },
            item3: {
        ...
        item2: {
          ...
          answer: {
            ...
            item3: {
              ...
              description:
                "Crafting key messages that resonate with the target audience.",
            },
            item4: {
              title: "Implementation & Monitoring",
              description:
                "Applying the brand across all channels and monitoring performance.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "A design audit evaluates a product's design effectiveness, identifying strengths, weaknesses, and areas for improvement.",
        },
        item2: {
          ...
          answer: {
            ...
            item2: {
              ...
              description:
                "Provides recommendations to improve user satisfaction.",
            },
            item3: {
        ...
        item2: {
          ...
          answer: {
            item1: {
              ...
              description:
                "Assessing design against established usability principles.",
            },
            item2: {
              title: "User Testing",
            ...
            item4: {
              ...
              description:
                "Gathering insights from team members about design perceptions.",
            },
          },
        },
      },
    ...
    AboutItem: {
      section1: {
        item1: {
          ...
          answer:
            "Prototyping involves creating early samples or models of a product to test concepts and functionalities.",
        },
        item2: {
          ...
          answer: {
            ...
            item3: {
              ...
              description:
                "Identifies potential issues early to reduce later costs.",
            },
            item4: {
        ...
        item2: {
          ...
          answer: {
            ...
            item2: {
              ...
              description:
                "Developing detailed representations of the final product.",
            },
            item3: {
            ...
            item4: {
              ...
              description:
                "Gathering insights from users to inform design iterations.",
            },
          },
        },
      },
